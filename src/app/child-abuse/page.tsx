  ...
  return (
    <div className="container mx-auto py-10 md:py-20 px-4 md:px-20 w-full">
      <div className="flex justify-between flex-col gap-5 md:min-h-[200px] h-fit items-center">
        <p className="md:text-[50px] text-4xl font-bold"><span className="text-[#2a66ec]">Child Abuse</span> is wickedness, <span className="text-[#2a66ec]">Child Marriage</span> is not good</p>
