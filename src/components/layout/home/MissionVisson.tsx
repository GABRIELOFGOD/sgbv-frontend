const MissionVisson = () => {
  return (
    <div className="w-full bg-white py-10 px-4 md:px-10 flex flex-col md:flex-row gap-5 container mx-auto">
      <div className="bg-[#2a66ec] rounded-lg p-4 text-white flex flex-col gap-4">
